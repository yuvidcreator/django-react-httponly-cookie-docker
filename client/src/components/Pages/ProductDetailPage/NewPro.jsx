...
const NewPro = () => {
    return (
        <section className="pt-24 lg:pt-36 pb-24 bg-blueGray-100 rounded-b-10xl overflow-hidden">
                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="w-full px-4">
                        <ul className="flex flex-wrap items-center mb-16">
                            ...
                            <li>
                                <Link className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">
                                    Apple iPhone 12 PRO
                                </Link>
                            </li>
                        </ul>
                        ...
                        <div className="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
                            <div className="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
                                ...
                                <Link className="h-30 block mb-4 mr-2 sm:mr-0" href="#">
                                    <img className="h-full w-full" src="/images/products/desi-ghee/desi-ghee.png" alt="" />
                                </Link>
                            ...
                            <div className="w-full sm:w-9/12 px-4">
                                <img className="mb-5" src="/images/products/desi-ghee/desi-ghee.png" alt="" />
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="max-w-md mb-6">
                            ...
                            <h2 className="mt-6 mb-4 text-2xl md:text-3xl lg:text-5xl font-heading font-medium">Apple iPhone 12 Pro (128GB) - Silver</h2>
                            <p className="flex items-center mb-6">
                                <span className="mr-2 text-sm text-blue-500 font-medium">$</span>
                                <span className="text-xl text-blue-500 font-medium">44.90</span>
                            </p>
                        ...
                        <div className="flex flex-wrap -mx-2 mb-12">
                            <div className="w-full md:w-2/3 px-2 mb-2 md:mb-0"><Link className="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl" href="#">Add to bag</Link></div>
                            <div className="w-full md:w-1/3 px-2">
                                <Link className="flex w-full py-4 px-2 items-center justify-center leading-8 font-heading font-medium tracking-tighter text-xl text-center bg-white focus:ring-2 focus:ring-gray-200 focus:ring-opacity-50 hover:bg-opacity-60 rounded-xl" href="#">
